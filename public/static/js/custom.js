...
/*
    ...
    $(function() {
        $('a.set_theme').click(function() {
			...
			setTimeout(function () { 
			$("link[title='style']").attr("href",base_path+"/themes/" + theme_name + "/ui.css");
			}, 500);			
		...
		{
			theme = 'blue_sky';//默认为蓝色天空
		}
		$("a.set_theme[id="+ theme +"]").addClass("active");
		if (theme == 'black_rose') {
	        $("link[title='style']").attr("href",base_path+"/themes/black_rose/ui.css");
	    };

		if (theme == 'gray_standard') {
	        $("link[title='style']").attr("href",base_path+"/themes/gray_standard/ui.css");
	    };
		
		if (theme == 'gray_lightness') {
	        $("link[title='style']").attr("href",base_path+"/themes/gray_lightness/ui.css");
	    };

		if (theme == 'blueberry') {
	        $("link[title='style']").attr("href",base_path+"/themes/blueberry/ui.css");
	    };

		if (theme == 'apple_pie') {
	        $("link[title='style']").attr("href",base_path+"/themes/apple_pie/ui.css");
	    };

		if(theme == 'blue_sky'){
			$("link[title='style']").attr("href",base_path+"/themes/blue_sky/ui.css");
		};		

		if(theme == 'turquoise'){
			$("link[title='style']").attr("href",base_path+"/themes/turquoise/ui.css");
		};

		if (theme == 'salmon') {
	        $("link[title='style']").attr("href",base_path+"/themes/salmon/ui.css");
	    };
    });
